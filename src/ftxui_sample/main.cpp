...
// configuration step. It creates a namespace called `RawCppPractice`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", RawCppPractice::cmake::project_name, RawCppPractice::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", RawCppPractice::cmake::project_version);
      return EXIT_SUCCESS;
    }
